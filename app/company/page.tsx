    ...
    <>
      ...
      <section className="bg-white pb-24 pt-6 md:pb-32">
        <div className="container-page">
          <Reveal>
            <p className="eyebrow mb-6">About Company</p>
            <h2 className="text-[clamp(1.75rem,4.2vw,3.25rem)] font-bold leading-[1.4] text-primary">
              BaseAIについて
            </h2>
          </Reveal>

          <Reveal delay={0.1}>
            <div className="mt-10 max-w-2xl space-y-6 text-base leading-loose text-primary/70 md:text-lg">
              <p>
